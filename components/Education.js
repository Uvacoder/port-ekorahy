...
function Education() {
  return (
    <section id="education">
      <h1 className="text-lg font-Kanit font-semibold lg:text-2xl">Education
      </h1>
      <div className="flex flex-col">
        ...
        <SubAbout title="Dicoding Indonesia" subTitle="Studi Independen Bersertifikat Kampus Merdeka Batch 2 Program - Learning Path Front-End Web and Back-End Developer" date="Feb 2022 - Aug 2022" description="Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi accusantium adipisci labore libero facere illo atque soluta pariatur ratione quia!" place="Online Learning" />
